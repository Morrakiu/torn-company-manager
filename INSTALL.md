...
**Version:** 3.25.2 · **Author:** Morrakiu
...
2. Open the **raw** script on GitHub: [Torn_Company_Manager.user.js](./Torn_Company_Manager.user.js) and choose **Install**.  
   The **complete v3.25.2** userscript is on the **`Morrakiu-TCM-Beta`** branch (not a stub).
...
5. Optional — **Data Sync** in the panel:
   - **JSONBin** — web ↔ PDA (trains, metrics, Discord, peers). Same Bin ID + Master Key on every device. Needs HTTP **PUT** (GMforPDA **2.3+** on PDA).
